...
{
    public class MemoryReadFailure
    {
    ...
    public class SharedMemory
    {
        ...
        public EventHandler<MemoryReadFailure> OnMemoryReadFailed;
        ...
        public async Task Refresh()
        {
            await Task.Run(() =>
            {
                ...
                {
                    OnMemoryReadFailed?.Invoke(this, new MemoryReadFailure { Description = fnfe.Message });
                }
            });
        }
    }
